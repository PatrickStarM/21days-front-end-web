<template>
  <view>
    <!-- 自定义导航 -->
    <uni-nav-bar leftIcon="back" leftText="返回" rightIcon="location" statusBar="true" backgroundColor="#ffcc80" color="#fff" @click-left="back">
    ...
    <!-- 文本域 -->
    <textarea v-model="content" placeholder="说一句话吧" 
    class="input-area" />
    <!-- 多图上传 -->
    <upload-image @change="changeImage" 
  :list="imageList"
  ref="uploadImage"
  :show="show"
  ></upload-image>
